...
router.post("/", roleController.grantAccess("createOwn","youtube"), youtubeController.create);
router.get("/", roleController.grantAccess("readAny","youtube"), youtubeController.view);
